...
res1 = @benchmark size_aircraft!(ac, iter=50; printiter = false) seconds=15 samples=5
...
res2 = @benchmark size_aircraft!(ac, iter=50; printiter = false) seconds=15 samples=5
...
res3 = @benchmark size_aircraft!(ac, iter=50; printiter = false) seconds=15 samples=5
...
res4 = @benchmark size_aircraft!(ac, iter=50; printiter = false) seconds=15 samples=5
